...
%     title(channel_name);
    ...
    %title('Red Microspheres (10\mum)')
    %title('Fluorescein (~1nm)')
    title('Blue Nanospheres (20nm)')
    xlabel('Channel Length (\mum)','FontSize',12, 'FontWeight', 'bold')
    ylabel('Fluorescent Signal (au)','FontSize',12, 'FontWeight', 'bold')
    hold on
    yL = get(gca,'YLim');
